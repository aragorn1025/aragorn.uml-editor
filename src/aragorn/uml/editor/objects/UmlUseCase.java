...
public class UmlUseCase extends UmlBasicObject {
	...
	public static final Paintable BUTTON_ICON = new UmlUseCase(0, 1, 8, 6);
	...
	private UmlUseCase(double x, double y, double width, double height) {
	...
	public UmlUseCase(Point point) {
		this(point.getX(), point.getY(), UmlUseCase.DEFAULT_SIZE.getWidth(), UmlUseCase.DEFAULT_SIZE.getHeight());
	}
